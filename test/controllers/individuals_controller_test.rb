...
class IndividualsControllerTest < ActionController::TestCase
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post :create, individual: { company_id: @individual.company_id, email: @individual.email, first_name: @individual.first_name, last_name: @individual.last_name, website: @individual.website }
    end
  ...
  test "should update individual" do
    patch :update, id: @individual, individual: { company_id: @individual.company_id, email: @individual.email, first_name: @individual.first_name, last_name: @individual.last_name, website: @individual.website }
    assert_redirected_to individual_path(assigns(:individual))
  end
